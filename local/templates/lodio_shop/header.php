...
<div class="wrap"><?
        ...
        <div class="container"><?
            ...
            <div class="header__inner"><?
                ...
                <div class="header__buttons">
                    ...
                    <div class="mobile-menu"><a data-toggle="collapse" href="#mobileMenuAuth" class="mobile-menu__btn"><i class="fa fa-user" aria-hidden="true"></i></a></div>
    ...
    ?>
    <section id="mobileMenuAuth" class="collapse">
        <? $APPLICATION->IncludeComponent(
            "bitrix:menu",
            "top-menu-auth",
            array(
