...
{	
	...
	{
		$arSmallPicture = CFile::ResizeImageGet($arItemP['PREVIEW_PICTURE']['ID'], array('width'=>460, 'height'=>331), BX_RESIZE_IMAGE_EXACT, true); 
	...
	{
		$arItemP['PICTURE_SRC'] = SITE_TEMPLATE_PATH."/images/no-photo-460-331.png";	
		$arItemP['PICTURE_WIDTH'] = '460';
		$arItemP['PICTURE_HEIGHT'] = '331';		
	}
}
?>