...
{	
	...
	{
		$arSmallPicture = CFile::ResizeImageGet($arItemP['PREVIEW_PICTURE']['ID'], array('width'=>47, 'height'=>47), BX_RESIZE_IMAGE_PROPORTIONAL, true); 
	...
	{
		$arItemP['PICTURE_SRC'] = SITE_TEMPLATE_PATH."/images/no-photo-47-47.png";	
		$arItemP['PICTURE_WIDTH'] = '47';
		$arItemP['PICTURE_HEIGHT'] = '47';		
	}
}
?>