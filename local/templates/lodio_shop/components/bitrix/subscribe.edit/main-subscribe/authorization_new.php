...
<?elseif($arResult["ALLOW_ANONYMOUS"]=="N" || $_REQUEST["authorize"]=="YES" || $_REQUEST["register"]=="YES"):?>
	...
	<tr valign="top">
		<td width="40%">
			<p><?echo GetMessage("adm_auth_login")?><span class="starrequired">*</span><br /><br />
			<input class="input" type="text" name="LOGIN" value="<?echo $arResult["REQUEST"]["LOGIN"]?>" size="20" /></p>
			<p><?echo GetMessage("adm_auth_pass")?><span class="starrequired">*</span><br /><br />
	...
	<tfoot><tr><td colspan="2"><input class="btn" type="submit" name="Save" value="<?echo GetMessage("adm_auth_butt")?>" /></td></tr></tfoot>
	</table>
	...
	<?if($arResult["ALLOW_REGISTER"]=="Y"):
		...
		<tr valign="top">
			<td width="40%">
			<p><?echo GetMessage("adm_reg_login")?><span class="starrequired">*</span><br /><br />
			<input type="text" name="NEW_LOGIN" value="<?echo $arResult["REQUEST"]["NEW_LOGIN"]?>" size="20" /></p>
			<p><?echo GetMessage("adm_reg_pass")?><span class="starrequired">*</span><br /><br />
			<input type="password" name="NEW_PASSWORD" size="20" value="<?echo $arResult["REQUEST"]["NEW_PASSWORD"]?>" /></p>
			<p><?echo GetMessage("adm_reg_pass_conf")?><span class="starrequired">*</span><br /><br />
			...
			<input class="input" type="text" name="EMAIL" value="<?=$arResult["SUBSCRIPTION"]["EMAIL"]!=""?$arResult["SUBSCRIPTION"]["EMAIL"]:$arResult["REQUEST"]["EMAIL"];?>" size="30" maxlength="255" /></p>
		<?
			/* CAPTCHA */
			...
			?>
				...
				<p><?=GetMessage("subscr_CAPTCHA_REGF_PROMT")?><span class="starrequired">*</span><br /><br />
		...
		<tfoot><tr><td colspan="2"><input class="btn" type="submit" name="Save" value="<?echo GetMessage("adm_reg_butt")?>" /></td></tr></tfoot>
		</table>
		<?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
			<input type="hidden" name="RUB_ID[]" value="<?=$itemValue["ID"]?>">
		<?endforeach;?>
