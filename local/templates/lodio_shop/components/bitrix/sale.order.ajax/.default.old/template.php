...
<div class="content-wrap">
	<div class="container confirm">
		<h1 class="title decor-title"><span><?=getMessage("LODIO_ORDER_NAME_1")?></span><span><?=getMessage("LODIO_ORDER_NAME_2")?></span></h1>
		<div class="confirm__row">
            <div class="divider-wrap">
              <h2 class="confirm__title divider"><?=getMessage("LODIO_ORDER_SUMMARY")?></h2>
            </div>
			<div class="confirm__order-table confirm__item">
				<div class="confirm__order-head">
					<div class="confirm__order-cell"><?=getMessage("LODIO_ORDER_SUMMARY_NAME")?></div>
					<div class="confirm__order-cell"><?=getMessage("LODIO_ORDER_SUMMARY_QUANTITY")?></div>
					<div class="confirm__order-cell"><?=getMessage("LODIO_ORDER_SUMMARY_PRICE")?></div>
				</div>
				<?foreach ($arResult["GRID"]["ROWS"] as $k => $arData):?>
					<div class="confirm__order-row">
						<div class="confirm__order-cell"><?=$arData['data']['NAME']?></div>
						<div class="confirm__order-cell"><?=$arData['data']['QUANTITY']?></div>
						<div class="confirm__order-cell"><?=$arData['data']['PRICE_FORMATED']?></div>
					</div>
				<?endforeach?>
				<div class="confirm__order-foot">
					<div class="confirm__order-cell"></div>
					<div class="confirm__order-cell"><?=getMessage("LODIO_ORDER_TOTAL")?>:</div>
					<div class="confirm__order-cell"><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></div>
				</div>
			</div>
		</div>
		<div class="confirm__row">
			<div class="divider-wrap">
				<h2 class="confirm__title divider"><?=getMessage("LODIO_ORDER_PROPS");?></h2>
			</div>
				...
				<div class="confirm__form confirm__item">
					<div class="row">
						<div class="col-sm-6">
							<div class="row">
								<?$counter = 1;?>
								<?foreach ($arResult['ORDER_PROP']['ALL'] as $orderField):?>
									<?if ($counter >= count($arResult['ORDER_PROP']['ALL'])/2 ):?>
										</div></div><div class="col-sm-6"><div class="row">								
									<?endif?>
									<div class="confirm__form-item col-sm-12">
										<label for=""><?=$orderField['NAME']?></label>
										<?if ($orderField['TYPE'] == 'TEXT'):?>
											<input type="text" name="<?=$orderField['FIELD_ID']?>" class="input" value="<?=$orderField['VALUE']?>">
										<?else:?>
											<?$APPLICATION->IncludeComponent(
												...
												Array(
													...
													"CITY_INPUT_NAME" => $orderField['FIELD_ID'],
													"COUNTRY" => "",
													"ONCITYCHANGE" => "",
													"NAME" => ""
												)
          ...
          <div class="confirm__row">
            <div class="divider-wrap">
              <h2 class="confirm__title divider">delivery options</h2>
              <div class="confirm__item confirm__options">
                <div class="row confirm__options-item">
                  <div class="col-sm-6">
                    <div class="checkbox">
                      <input type="checkbox" id="checkbox1">
                      <label for="checkbox1">USPS</label>
                    </div>
                    <div class="checkbox">
                      <input type="checkbox" id="checkbox2">
                      <label for="checkbox2">DHL</label>
                    </div>
                    <div class="checkbox">
                      <input type="checkbox" id="checkbox3">
                      <label for="checkbox3">FedEx</label>
                    </div>
                    <div class="checkbox">
                      <input type="checkbox" id="checkbox4">
                      <label for="checkbox4">EMS</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="radio">
                ...
                <div class="row confirm__btn confirm__options-item"><a href="#" class="btn">pay now</a></div>
              </div>
            </div>
          </div>
        </div>
