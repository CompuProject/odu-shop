...
{	
	...
	{
		$arSmallPicture = CFile::ResizeImageGet($arItemP['PREVIEW_PICTURE']['ID'], array('width'=>268, 'height'=>178), BX_RESIZE_IMAGE_EXACT, true); 
	...
	{
		$arItemP['PICTURE_SRC'] = SITE_TEMPLATE_PATH."/images/no-photo-268-178.png";	
		$arItemP['PICTURE_WIDTH'] = '268';
		$arItemP['PICTURE_HEIGHT'] = '178';		
	}
}
?>