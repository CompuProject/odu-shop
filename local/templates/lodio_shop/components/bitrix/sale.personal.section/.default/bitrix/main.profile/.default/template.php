		...
		<div class="main-profile-block-shown" id="user_div_reg">
			...
			if (!in_array(LANGUAGE_ID,array('ru', 'ua')))
			{
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input class="input form-control" type="text" name="TITLE" id="main-profile-title" value="<?=$arResult["arUser"]["TITLE"]?>" />
					</div>
				</div>
				<?
			}
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					<input class="input form-control" type="text" name="NAME" id="main-profile-name" value="<?=$arResult["arUser"]["NAME"]?>" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-12">
					<input class="input form-control" type="text" name="LAST_NAME" id="main-profile-last-name" value="<?=$arResult["arUser"]["LAST_NAME"]?>" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-12">
					<input class="input form-control" type="text" name="SECOND_NAME" id="main-profile-second-name" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" />
				</div>
			</div>
			<div class="form-group">
			...
			if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == '')
			{
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input class="input form-control bx-auth-input main-profile-password" type="password" name="NEW_PASSWORD" id="main-profile-password" value="" autocomplete="off"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input class="input button btn form-control" type="password" name="NEW_PASSWORD_CONFIRM" value="" id="main-profile-password-confirm" autocomplete="off" />
					</div>
				</div>
				<?
			}
